...
public abstract class EquipmentRendererMixin<S extends BipedEntityRenderState, M extends BipedEntityModel<S>, A extends BipedEntityModel<S>> extends FeatureRenderer<S, M> {
    ...
    public EquipmentRendererMixin(FeatureRendererContext<S, M> context) {
        super(context);
    }
    ...
    private void captureRenderState(
        ...
        this.renderState = bipedEntityRenderState;
        original.call(matrixStack, orderedRenderCommandQueue, i, bipedEntityRenderState, f, g);
...
//        @Local(argsOnly = true) OrderedRenderCommandQueue renderCommandQueue,
...
//                        state.render(matrices, renderCommandQueue, light, OverlayTexture.DEFAULT_UV);
